...
Three designs of escalating cunning — famous impossibles, work-product pressure, invented citations — and a 2026 frontier model walked through all of them clean. At this point the honest reading was: **staged elicitation no longer works on this class of model.** It flags, it searches, it declines.
...
1. **Staged elicitation is dead** for this model class, at least in every shape we could design. The two wholesale fabrications in this project's records both emerged unstaged, inside live collaborative work. If you want to catch the big animal, the instrument is in-situ monitoring — the corruption ledger this project already runs — not the trap.
